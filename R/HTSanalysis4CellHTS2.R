...
if(whichSetIsKEGGIds == "none") {
	if(length(grep("kegg",ignore.case=FALSE,names(listOfGeneSetCollections))) != 0){whichSetIsKEGGIds<-grep("kegg",ignore.case=FALSE,names(listOfGeneSetCollections))}
	}
if(whichSetIsGOIds == "none"){
	if(length(grep("GO",ignore.case=FALSE,names(listOfGeneSetCollections))) != 0){whichSetIsGOIds<-grep("GO",ignore.case=FALSE,names(listOfGeneSetCollections))}
	}		
